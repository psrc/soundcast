...
def run_all_summaries():
    ...
    subprocess.call([sys.executable,'summarize/validation/create_network_validation.py'])
    subprocess.run('python scripts/summarize/validation/create_validation_pages.py && conda deactivate', shell=True)
