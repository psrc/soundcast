...
class EmploymentType(IntEnum):
    """
    Provides an integer mapping for a persons employment type.
    """
...
class StudentType(IntEnum):
    """
    Provides an integer mapping for a persons student type.
    """

    PRESCHOOL_THROUGH_GRADE_12 = 1
    UNIVERSITY_PROFESSIONAL_SCHOOL = 2
    NOT_STUDENT = 3
