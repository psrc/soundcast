...
def main():
    ...
    output_dir = os.path.join(os.getcwd(),config['p_output_dir'],'network-validation-notebook')
    ...
    shutil.move((os.path.join(r'scripts/summarize/validation_network',"network-validation-notebook")),
               output_dir)
