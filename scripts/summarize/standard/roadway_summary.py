...
def sum_vmt_class(vmt_df_class, net_summary, order_df):
	...
	vmt_tot = pd.DataFrame(vmt_df.sum()).T
...
def main():
	...
	sum_vmt_class(vmt_df_class=vmt_df_class, net_summary=net_summary, order_df=order_df)
