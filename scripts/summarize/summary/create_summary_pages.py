...
def main():
    ...
    output_dir = Path.cwd() / config["p_output_dir"] / "run-comparison-notebook"
    ...
    text = "quarto render scripts/summarize/summary"
    os.system(text)
    ...
    shutil.move(Path.cwd() / "scripts/summarize/summary/run-comparison-notebook", output_dir)
