...
def main():
    ...
    writer = pd.ExcelWriter('outputs/network_summary.xlsx', engine = 'xlsxwriter')#Defines the file to write to and to use xlsxwriter to do so
   ...
   #write out transit:
    ...
    df.to_excel(excel_writer = writer, sheet_name = 'Counts Output')
    ...
    screenline_df['Screenline'] = screeline_dict.keys()
    screenline_df['Volumes'] = screenlind_dict.values()
