...
Trip_deptm_graph + geom_histogram(binwidth = 1.5, colour= "black",position= position_dodge(width =1.0), alpha = 1.0) +xlab("Trip Departure Time") + ylab("Percent of Trips") +scale_x_continuous(breaks=number_ticks(12))  
@
\end{document}