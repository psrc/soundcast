...
def prepare_inputs(use_sample, output_dir):
...
def assign_parcels(df, df_size_terms, segment, model_selector, target_col):
    ...
    df_to_maz = assign_to_parcel(df, target_col, segment_weights)
...
def assign_to_parcel(df, target_col, segment_weights):
...
person_df, hh_df, tour_df, trip_df, df_size_terms, df_parcel = prepare_inputs(use_sample, output_dir)
