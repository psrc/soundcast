...
def build_output_dirs():
    for path in ['outputs',r'outputs/daysim',r'outputs/activitysim','outputs/bike'
                 ,'outputs/network','outputs/transit', 'outputs/landuse',
                 'outputs/emissions',r'outputs/trucks', 'outputs/supplemental']:
