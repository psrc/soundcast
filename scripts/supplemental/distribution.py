...
def json_to_dictionary(dict_name):
    ...
    input_filename = os.path.join('D:/supplemental/soundcast_12_17_14/soundcast/inputs/supplemental/',dict_name+'.json').replace("\\","/")
    my_dictionary = json.load(open(input_filename))

    return(my_dictionary)

# Load the trip productions and attractions
trip_table = pd.read_csv(r'D:\supplemental\soundcast_12_17_14\soundcast\outputs\prod_att.csv', index_col="taz")  # total 4K Ps and As by trip purpose
gq_trip_table = pd.read_csv(r'D:\supplemental\soundcast_12_17_14\soundcast\outputs\gq_prod_att.csv', index_col="taz")  # only group quarter Ps and As
...
# Other inputs 
supplemental_loc = 'D:/supplemental/soundcast_12_17_14/soundcast/outputs/supplemental/'
output_dir = 'D:/supplemental/soundcast_12_17_14/soundcast/outputs/supplemental/'
ext_spg_dir = 'D:/supplemental/soundcast_12_17_14/soundcast/outputs/supplemental/ext_spg' # External and special generator trips generated by zone
gq_directory = 'D:/supplemental/soundcast_12_17_14/soundcast/outputs/supplemental/group_quarters' # Temporarily store group quarters trip table
...
def main():
    ...
    # Load skim data
    am_cost_skim = load_skims(r'D:\supplemental\soundcast_12_17_14\soundcast\inputs\7to8.h5', mode_name='svtl2g')
    am_dist_skim = load_skims(r'D:\supplemental\soundcast_12_17_14\soundcast\inputs\7to8.h5', mode_name='svtl1d', divide_by_100=True)
    pm_cost_skim = load_skims(r'D:\supplemental\soundcast_12_17_14\soundcast\inputs\17to18.h5', mode_name='svtl2g')
    pm_dist_skim = load_skims(r'D:\supplemental\soundcast_12_17_14\soundcast\inputs\17to18.h5', mode_name='svtl1d', divide_by_100=True)
    ...
    export_trips(split_by_mode_tod, output_dir = 'D:/supplemental/soundcast_12_17_14/soundcast/outputs/supplemental')

    # Report results in CSV summary
    supplementals_report(ext_spg_trimmed, gq_summary, combined, split_by_mode_tod)

my_project = EmmeProject(r'D:\supplemental\soundcast_12_17_14\soundcast\projects\Supplementals\Supplementals.emp')
